...
String Isx_f= "Isxodn_f.txt",
       Rez_f= "Rezylt_f.txt";//Объявление файловых перемен
//---------------------------------------------------------------------------
...
void __fastcall TForm1::VvodClick(TObject *Sender)
{
 ...
 ShowMessage("Загружено " + IntToStr(Memo1->Lines->Count) + " строк");
}//VvodClick
//---------------------------------------------------------------------------
...
/*String Isx_f= "Isxodn_f.txt",
       Rez_f= "Rezylt_f.txt";*/
//обьявление и инициализация указателя
...
{
 Zagryzka (Spisok, Isx_f);//иллюстрация работы с объектом TStringList
